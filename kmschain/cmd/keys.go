...
func generatePrivateKey(sc *kmschain.KMSChain, w io.Writer) {
...
func getPublicKey(sc *kmschain.KMSChain, w io.Writer) {
...
func generateReEncryptionKey(sc *kmschain.KMSChain, w io.Writer) {
...
func encapsulate(sc *kmschain.KMSChain, w1 io.Writer, w2 io.Writer) {
...
func decapsulate(sc *kmschain.KMSChain, w io.Writer) {
...
func reEncrypt(sc *kmschain.KMSChain, w io.Writer) {
